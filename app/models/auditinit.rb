class Auditinit < ActiveRecord::Base
  attr_accessible :title,:purpose,:scope,:summary,:start_date,:end_date,:close_date,:target_date,:a_type,:department,:location,:auditor_name,:auditor_email,:auditee_name,:auditee_email,:user_id
